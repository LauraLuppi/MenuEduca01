    ...
    public partial class Completa : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CadastroUsuarioId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CadastroUsuarios", x => x.CadastroUsuarioId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InsercaoMedicas_CadastroUsuarios_CadastroUsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Avaliacaos_CadastroUsuarios_CadastroUsuarioId",
                        column: x => x.CadastroUsuarioId,
                        principalTable: "CadastroUsuarios",
                        principalColumn: "CadastroUsuarioId");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "253560dc-74f6-4e99-8769-f36977816d32", null, "Aluno", "ALUNO" },
                    { "a18fbf85-e4ce-494a-a4a6-bbeed2eb107f", null, "CadastroUsuario", "CADASTROUSUARIO" },
                    { "f1c3429c-e068-41c5-ba6a-b50027971cbd", null, "Nutricionista", "NUTRICIONISTA" }
                });
